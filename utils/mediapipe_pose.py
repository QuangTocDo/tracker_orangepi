...
class HumanDetection:
    ...
    """
    def __init__(self, person_model='python/models/yolo11.rknn', pose_model='python/face_processing/models/pose_landmarker.task'):
        ...
        options = PoseLandmarkerOptions(
            ...
            num_poses=1, # Chỉ xử lý 1 người trong mỗi crop để tối ưu
    ...
    def detect_pose_from_bbox(self, full_frame: np.ndarray, bbox: tuple):
            ...
            try:
                ...
                if detection_result.pose_landmarks:
                    ...
                    return person_keypoints, person_z

                return None, None # Không tìm thấy pose
